...
if uploaded_file is not None:
    ...
    data = bytes_data.decode("utf-8")  # for convert bytes to string
    ...
    if st.sidebar.button("Show Analysis"):
        ...
        # words = helper.fetch_stats(selected_user, df)
        ...
        if selected_user == 'Overall':
            ...
            x,new_df = helper.buesy_user(df)
            fig, ax = plt.subplots()
    # for print plot first install matplotlib in terminal
            col1, col2 = st.columns(2)
            with col1:
